...
- [ ] [Task 1](./tasks/TASK1-add-scry-theme-tokens-and-pane-chrome.md) — Add scry-aligned theme tokens, shared TUI styles, a local bordered-pane helper, height-aware footer/status primitives, and ANSI-aware helper tests in `tools/party-cli/internal/tui/` (deps: none)
