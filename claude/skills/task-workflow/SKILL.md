...
2. **Scribe inclusion** — Because planned work has requirements, scribe runs alongside critics per [Scribe Contract](~/.claude/rules/execution-core.md#scribe-contract).
